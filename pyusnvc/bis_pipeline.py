...
#     globals()['process_{}'.format(stage)](path,
...
def process_1(path, ch_ledger, send_final_result,
...
# It returns 1
def process_2(path, ch_ledger, send_final_result,
              send_to_stage, previous_stage_result):
